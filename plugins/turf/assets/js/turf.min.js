...
"use strict";function _interopDefault(n){return n&&"object"==typeof n&&"default"in n?n.default:n}function booleanDisjoint(n,e){var o;return meta.flattenEach(n,function(n){meta.flattenEach(e,function(e){if(!1===o)return!1;o=disjoint(n.geometry,e.geometry)})}),o}function disjoint(n,e){switch(n.type){case"Point":switch(e.type){case"Point":return!compareCoords(n.coordinates,e.coordinates);case"LineString":return!isPointOnLine(e,n);case"Polygon":return!booleanPointInPolygon(n,e)}break;case"LineString":switch(e.type){case"Point":return!isPointOnLine(n,e);case"LineString":return!isLineOnLine(n,e);case"Polygon":return!isLineInPoly(e,n)}break;case"Polygon":switch(e.type){case"Point":return!booleanPointInPolygon(e,n);case"LineString":return!isLineInPoly(n,e);case"Polygon":return!isPolyInPoly(e,n)}}}function isPointOnLine(n,e){for(var o=0;o<n.coordinates.length-1;o++)if(isPointOnLineSegment(n.coordinates[o],n.coordinates[o+1],e.coordinates))return!0;return!1}function isLineOnLine(n,e){return lineIntersect(n,e).features.length>0}function isLineInPoly(n,e){for(var o=0;o<e.coordinates.length;o++)if(booleanPointInPolygon(e.coordinates[o],n))return!0;return lineIntersect(e,polygonToLine(n)).features.length>0}function isPolyInPoly(n,e){for(var o=0;o<n.coordinates[0].length;o++)if(booleanPointInPolygon(n.coordinates[0][o],e))return!0;for(var t=0;t<e.coordinates[0].length;t++)if(booleanPointInPolygon(e.coordinates[0][t],n))return!0;return lineIntersect(polygonToLine(n),polygonToLine(e)).features.length>0}function isPointOnLineSegment(n,e,o){var t=o[0]-n[0],i=o[1]-n[1],r=e[0]-n[0],a=e[1]-n[1];return 0==t*a-i*r&&(Math.abs(r)>=Math.abs(a)?r>0?n[0]<=o[0]&&o[0]<=e[0]:e[0]<=o[0]&&o[0]<=n[0]:a>0?n[1]<=o[1]&&o[1]<=e[1]:e[1]<=o[1]&&o[1]<=n[1])}function compareCoords(n,e){return n[0]===e[0]&&n[1]===e[1]}var booleanPointInPolygon=_interopDefault(require("@turf/boolean-point-in-polygon")),meta=require("@turf/meta"),lineIntersect=_interopDefault(require("@turf/line-intersect")),polygonToLine=_interopDefault(require("@turf/polygon-to-line"));module.exports=booleanDisjoint,module.exports.default=booleanDisjoint;
},{"@turf/boolean-point-in-polygon":2,"@turf/line-intersect":5,"@turf/meta":7,"@turf/polygon-to-line":8}],2:[function(require,module,exports){
"use strict";function booleanPointInPolygon(n,r,o){if("object"!=typeof(o=o||{}))throw new Error("options is invalid");var e=o.ignoreBoundary;if(!n)throw new Error("point is required");if(!r)throw new Error("polygon is required");var i=invariant.getCoord(n),t=invariant.getCoords(r),a=r.geometry?r.geometry.type:r.type,g=r.bbox;if(g&&!1===inBBox(i,g))return!1;"Polygon"===a&&(t=[t]);for(var l=0,u=!1;l<t.length&&!u;l++)if(inRing(i,t[l][0],e)){for(var f=!1,v=1;v<t[l].length&&!f;)inRing(i,t[l][v],!e)&&(f=!0),v++;f||(u=!0)}return u}function inRing(n,r,o){var e=!1;r[0][0]===r[r.length-1][0]&&r[0][1]===r[r.length-1][1]&&(r=r.slice(0,r.length-1));for(var i=0,t=r.length-1;i<r.length;t=i++){var a=r[i][0],g=r[i][1],l=r[t][0],u=r[t][1];if(n[1]*(a-l)+g*(l-n[0])+u*(n[0]-a)==0&&(a-n[0])*(l-n[0])<=0&&(g-n[1])*(u-n[1])<=0)return!o;g>n[1]!=u>n[1]&&n[0]<(l-a)*(n[1]-g)/(u-g)+a&&(e=!e)}return e}function inBBox(n,r){return r[0]<=n[0]&&r[1]<=n[1]&&r[2]>=n[0]&&r[3]>=n[1]}var invariant=require("@turf/invariant");module.exports=booleanPointInPolygon,module.exports.default=booleanPointInPolygon;
},{"@turf/invariant":4}],3:[function(require,module,exports){
...
},{"@turf/helpers":3,"@turf/invariant":4,"@turf/line-segment":6,"@turf/meta":7,"geojson-rbush":9}],6:[function(require,module,exports){
...
},{"@turf/helpers":3,"@turf/invariant":4,"@turf/meta":7}],7:[function(require,module,exports){
...
},{"@turf/helpers":3}],8:[function(require,module,exports){
"use strict";function polygonToLine(e,r){if(r=r||{},!helpers.isObject(r))throw new Error("options is invalid");var o=r.properties,n=invariant.getType(e),t=invariant.getCoords(e);if(o=o||e.properties||{},!t.length)throw new Error("polygon must contain coordinates");switch(n){case"Polygon":return coordsToLine(t,o);case"MultiPolygon":var i=[];return t.forEach(function(e){i.push(coordsToLine(e,o))}),helpers.featureCollection(i);default:throw new Error("geom "+n+" not supported")}}function coordsToLine(e,r){return e.length>1?helpers.multiLineString(e,r):helpers.lineString(e[0],r)}var invariant=require("@turf/invariant"),helpers=require("@turf/helpers");module.exports=polygonToLine,module.exports.default=polygonToLine;

},{"@turf/helpers":3,"@turf/invariant":4}],9:[function(require,module,exports){
...
module.exports={booleanDisjoint:require("@turf/boolean-disjoint")};
},{"@turf/boolean-disjoint":1}]},{},[10])(10)
});
